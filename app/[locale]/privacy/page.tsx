...
import { buildPageMetadata, buildPrivacyJsonLd } from "@/lib/seo";
...
export async function generateMetadata({
  ...
  return buildPageMetadata(locale, "privacy", dict.privacy.meta);
}
...
export default async function PrivacyPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-full bg-background text-foreground">
      <JsonLd data={buildPrivacyJsonLd(locale, privacy)} />
